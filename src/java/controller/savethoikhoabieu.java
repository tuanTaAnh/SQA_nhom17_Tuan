 ...
 * @author tuan
 */
@WebServlet(name = "savethoikhoabieu", urlPatterns = {"/savethoikhoabieu"})
public class savethoikhoabieu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("noticeSaveTKB", notice);
