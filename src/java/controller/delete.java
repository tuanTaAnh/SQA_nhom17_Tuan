...
import static controller.thoikhoabieuDAO.deleteMonHoc;
...
public class delete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String maLopHocSearch = request.getParameter("maLHDelete");
        HttpSession session = request.getSession();
        session.setAttribute("resultDELETE", maLopHocSearch);
        
        String rs = deleteMonHoc(maLopHocSearch);
